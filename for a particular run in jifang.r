...
#09 0217 relap7fit280w3 14:01 (erv2 gaile, as acp rate too low)
erv2_relap7fit280w3=rep(0.01,14)
erv2_relap7fit280w3[1]=0.1
erv2_relap7fit280w3[2]=0.1
erv2_relap7fit280w3[3]=0.15
erv2_relap7fit280w3[4]=0.1
erv2_relap7fit280w3[5]=0.1
erv2_relap7fit280w3[6]=0.1
erv2_relap7fit280w3[7]=0.1
erv2_relap7fit280w3[8]=0.1
erv2_relap7fit280w3[9]=0.07
erv2_relap7fit280w3[10]=0.07
erv2_relap7fit280w3[11]=0.1
erv2_relap7fit280w3[12]=0.02
erv2_relap7fit280w3[13]=0.02
p7=whichdata(7,home=FALSE)
dim(p7)
plotdata(p7,patientnum=7)
a0=rep(0.5,14)
a0[14]=var(p7$ratio)
sink(file="relap7fit280w3sink(280,k=1000)fuben")
print(paste("erv2="))
print(erv2_relap7fit280w3)
print(paste("a0="))
print(a0)
relap7fit280w3=myMCMC14a_vtest_evk_realtestyesfuben(data=p7,v=1:14,a0=a0,n=2800000,k=1000,erv2=erv2_relap7fit280w3)
sink()

#08 0217 relap7fit280w4 14:01 (erv2 gaile, as acp rate too low)
erv2_relap7fit280w3=rep(0.01,14)
erv2_relap7fit280w3[1]=0.1
erv2_relap7fit280w3[2]=0.1
erv2_relap7fit280w3[3]=0.15
...
a0=rep(0.5,14)
a0[14]=var(p7$ratio)
sink(file="relap7fit280w4sink(280,k=1000)fuben")
print(paste("erv2="))
print(erv2_relap7fit280w4)
print(paste("a0="))
print(a0)
relap7fit280w4=myMCMC14a_vtest_evk_realtestyesfuben(data=p7,v=1:14,a0=a0,n=2800000,k=1000,erv2=erv2_relap7fit280w4)
sink()

#07 0217 relap7fit280w4 14:18 (erv2 gaile, as acp rate too low)
erv2_relap7fit280w3=rep(0.01,14)
erv2_relap7fit280w3[1]=0.1
erv2_relap7fit280w3[2]=0.1
erv2_relap7fit280w3[3]=0.15
...
a0=rep(0.5,14)
a0[14]=var(p7$ratio)
sink(file="relap7fit280w5sink(26W,k=1000)fuben")
print(paste("erv2="))
print(erv2_relap7fit280w5)
print(paste("a0="))
print(a0)
...
#using p25 in stats lib windows 0219 00:25
p25=whichdata(25,home=FALSE)
...
a0=rep(0.5,14)
a0[14]=var(p25$ratio)
erv2_relap25fit15w3=rep(0.01,14)
erv2_relap25fit15w3[1]=0.2
erv2_relap25fit15w3[2]=0.2
erv2_relap25fit15w3[3]=0.22
erv2_relap25fit15w3[4]=0.2
erv2_relap25fit15w3[5]=0.18
erv2_relap25fit15w3[6]=0.18
erv2_relap25fit15w3[7]=0.12
erv2_relap25fit15w3[8]=0.15
erv2_relap25fit15w3[9]=0.15
erv2_relap25fit15w3[10]=0.15
erv2_relap25fit15w3[11]=0.18
erv2_relap25fit15w3[12]=0.08
erv2_relap25fit15w3[13]=0.08
erv2_relap25fit15w3[14]=0.09

erv2_relap25fit15w4=rep(0.01,14)
erv2_relap25fit15w4[1]=0.24
erv2_relap25fit15w4[2]=0.24
erv2_relap25fit15w4[3]=0.26
erv2_relap25fit15w4[4]=0.24
erv2_relap25fit15w4[5]=0.22
erv2_relap25fit15w4[6]=0.22
erv2_relap25fit15w4[7]=0.15
erv2_relap25fit15w4[8]=0.20
erv2_relap25fit15w4[9]=0.20
erv2_relap25fit15w4[10]=0.20
erv2_relap25fit15w4[11]=0.22
erv2_relap25fit15w4[12]=0.12
erv2_relap25fit15w4[13]=0.12
erv2_relap25fit15w4[14]=0.09


sink(file="relap25fit15w3&4sink(15w,k=1000)fuben")
print(paste("erv2_w3="))
print(erv2_relap25fit15w3)
print("")
print(paste("erv2_w4="))
print(erv2_relap25fit15w4)

print(paste("a0="))
print(a0)
relap25fit15w3=myMCMC14a_vtest_evk_realtestyesfuben(data=p25,v=1:14,a0=a0,n=150000,k=1000,erv2=erv2_relap25fit15w3)
print("")
relap25fit15w4=myMCMC14a_vtest_evk_realtestyesfuben(data=p25,v=1:14,a0=a0,n=150000,k=1000,erv2=erv2_relap25fit15w4)
