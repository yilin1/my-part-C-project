...
myloglk=function(m,a1,t,tby,psdata,erv1=	1,sf=0.01){ ## this is calculating the likelihood given the real data: psdata, for the parameter indexed m to be a1,m is an interger between 1 and 13 inclusive,sf is the scaling factor as in noise() function.
	l=0
	if (m==1){
