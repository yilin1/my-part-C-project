#source("/Users/yilinsmac/Desktop/sigfile functions/14d/myMCMC14b_block function.r")
## function to perform MCMC based on previous functions: 
myMCMC14b_block=function(psdata,erv1=1,erv21=0.0001,erv22=0.00001,erv23=0.001,t=50,tby=1,n=3000){ 
#psdata is the real data to deal with; 
# erv1 is the noise variance, 
#erv21-23 are the variances of proposal distribution for i1-i5,c1-c8,rho respectively;
# n is the number of iterations in MCMC.

#this loops through 3 blocks in one iteration.
...
## i1,...,i5
mu1=curpars[1:5]	#get out current guess for the mth parameter we are interested in
