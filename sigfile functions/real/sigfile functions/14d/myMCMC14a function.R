#source("/Users/yilinsmac/Desktop/sigfile functions/14d/myMCMC14a function.r")
## function to perform MCMC based on previous functions: 
myMCMC14a=function(psdata,erv1=1,erv2=rep(0.01,14),t=50,tby=1,n=3000){ #psdata is the real data to deal with; erv1 is the noise variance, erv2 is the variance of proposal distribution; n is the number of times of MCMC.
