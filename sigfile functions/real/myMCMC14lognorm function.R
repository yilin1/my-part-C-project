myMCMC14lognorm=function(data,v,a0=rep(0.5,14),k=10,erv1=1,erv2=rep(0.01,14),tby=1,n=3000){ 
  ...
  lold=lognormallk(a1=a0,tby=tby,data=data,erv1=erv1)
  ...
  for (MCitr in 1:(n-1)){
    ...
    for (m in v){
      ...
      if (a2<0 || a2>1){
        ...
        curpars[m]=a2	
        lnew=lognormallk(a1=curpars,tby=tby,data=data,erv1=erv1)
