...
myMCMC14a_vtest_evk=function(psdata,v,k=10,erv1=1,erv2=rep(0.01,14),t=50,tby=1,n=3000){ #psdata is the real data to deal with; erv1 is the noise variance, erv2 is the variance of proposal distribution; n is the number of times of MCMC.
